...
Current stable release: **[v0.12.0](https://github.com/mqlens/mqlens-mongodb/releases/latest)** (shipped Jul 16, 2026)

Each upcoming milestone is planned as a **10-day** window. Dates below are targets, not hard deadlines.

## v0.13.0 — Workspace & extensibility

Window: **Jul 17 – Jul 26, 2026** · [Milestone](https://github.com/mqlens/mqlens-mongodb/milestone/7)

The big additive platform features, plus production-safety wins — landing a full release before 1.0 so they get real-world soak.
...
| [#191](https://github.com/mqlens/mqlens-mongodb/issues/191) | Aggregation builder UX: reorder, disable, run-to-here, undo/redo |
| [#192](https://github.com/mqlens/mqlens-mongodb/issues/192) | Atlas Search & Vector Search support |

## v1.0.0 — Hardening & launch

Window: **Aug 6 – Aug 15, 2026** · [Milestone](https://github.com/mqlens/mqlens-mongodb/milestone/5)
